...
public class PolygonRasterizer {
    ...
    /** Surface material by OSM highway tag -- asphalt-toned for real roads, dirt/path materials for foot traffic. */
    public static org.bukkit.Material materialForRoadType(String highwayTag) {
        return switch (highwayTag) {
            case "motorway", "trunk", "primary", "secondary" -> org.bukkit.Material.BLACK_CONCRETE_POWDER;
            case "tertiary", "residential" -> org.bukkit.Material.GRAY_CONCRETE_POWDER;
            case "service", "track" -> org.bukkit.Material.COARSE_DIRT;
            case "footway", "path", "pedestrian" -> org.bukkit.Material.DIRT_PATH;
            default -> org.bukkit.Material.GRAVEL;
        };
    }
}
